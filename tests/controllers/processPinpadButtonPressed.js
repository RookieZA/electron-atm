...
test('should properly handle pressed Backspace button for state F', t => {
  let state = new Map();
  state.set('number', '700');
  state.set('type', 'F');
  atm.current_state = state;
...
test('should properly handle pressed Enter button for state F', t => {
  let state = new Map();
  state.set('number', '700');
  state.set('type', 'F');
  atm.current_state = state;
...
test('should properly handle pressed Backspace button for state H', t => {
  let state = new Map();
  state.set('number', '700');
  state.set('type', 'H');
  state.set('FDK_A_next_state', '001');
