// Now uses window.electronAPI.showOpenDialog
$(function () {
  ...
  async function setImagePath() {
    var selected_image_path = await window.electronAPI.showOpenDialog({
    ...
    if (selected_image_path) {
      ...
      settings.get('image_path'); // Using the context API
